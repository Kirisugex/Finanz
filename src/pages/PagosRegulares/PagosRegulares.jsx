        ...
        <div className="PAGOS-REGULARES">
            <div className="div">
                <div className="overlap-group">
                    <div className="text-wrapper-70">+ CREAR</div>
                </div>
                <div className="text-wrapper-71"><Link to="/pagos-regulares-gastos" className="colorLink">GASTOS</Link></div>
                <div className="text-wrapper-99"><Link to="/pagos-regulares-ingresos" className="colorLink">INGRESOS</Link></div>
                <div className="text-wrapper-72">PAGOS REGULARES</div>
                <div className="group">
