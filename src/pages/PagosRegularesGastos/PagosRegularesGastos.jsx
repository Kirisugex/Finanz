...
export const PagosRegularesGastos = () => {
  ...
  return (
    <div className="PAGOS-REGULARES">
      <div className="div">
        ...
        <div className="text-wrapper-202">GASTOS</div>
        <div className="text-wrapper-201"><Link to="/pagos-regulares-ingresos" className="colorLink">INGRESOS</Link></div>
        <div className="text-wrapper-203"><Link to="/pagos-regulares" className="colorLink">PAGOS REGULARES</Link></div>
        <div className="group">
